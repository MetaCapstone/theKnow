...
export default function Search(props) {
  ...
  async function searchAPI(query, sortOrder = "asc", brandOwner = undefined) {
    ...
    params +=
      "&api_key=oDWPyC6zdMmMtm1ZtHe7prk8I18ZaFR5ShQ7QpYB&dataType=Branded&pageSize=20&pageNumber=2";
    setIsFetched(true);
  ...
  if (isFetched) {
    ...
    return (
      <>
          ...
          <div id="InputContainer" className="InputContainer">
            <div id="input">
              <input
                ...
                ref={inputEl}
              />
              <button className="buttons search" onClick={() => callFunction()}>
            ...
            <div id="myDropdown" className="dropdown-content">
              <button
                ...
                onClick={() => {
                  document.getElementById("input").innerHTML +=
                    "<input id='brandOwner' placeholder='Brand Owner' input='text' />";
                }}
              >
                Brand Owner
              </button>
              <button
                ...
                onClick={() => {
                  document.getElementById("input").innerHTML +=
                    "<input id='sortOrder' placeholder='asc or dec' input='text' />";
                }}
              >
                Sort Order
              </button>
        ...
        <button
          className={
            searched.length == 0 ? "buttons clear hidden" : "buttons clear"
          }
          onClick={() => {
            setSearched([]);
          }}
